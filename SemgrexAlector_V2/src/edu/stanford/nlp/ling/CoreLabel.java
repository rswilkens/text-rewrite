...
public class CoreLabel extends ArrayCoreMap implements AbstractCoreLabel, HasCategory /* , HasContext */  {
  ...
  public enum OutputFormat {
    VALUE_INDEX, VALUE, VALUE_TAG, VALUE_TAG_INDEX, MAP, VALUE_MAP, VALUE_INDEX_MAP, WORD, WORD_INDEX, VALUE_TAG_NER, LEMMA_INDEX, ALL, CoNLL, CoNLLcoref
  }
  ...
  public String toString(OutputFormat format) {
    ...
    case LEMMA_INDEX:
        ...
        break;
    case CoNLL:{
    	buf.append(this.get(CoreAnnotations.IndexAnnotation.class)).append("\t");
    	buf.append(this.value()).append("\t");
    	buf.append(this.get(CoreAnnotations.LemmaAnnotation.class)).append("\t");
        buf.append(this.get(CoreAnnotations.PartOfSpeechAnnotation.class)).append("\t");
        buf.append("_").append("\t");
        String feats = "_";
        HashMap<String, String> featsMap = this.get(CoreAnnotations.CoNLLUFeats.class);
        if(featsMap==null || featsMap.size()==0)
        	feats = "_";
        else
        	feats = featsMap.toString().replace("{", "").replace("}", "").replace(" ", "").replace(",", "|");
        
		buf.append(feats).append("\t");
        buf.append(this.get(CoreAnnotations.CoNLLDepParentIndexAnnotation.class)).append("\t");
        buf.append(this.get(CoreAnnotations.CoNLLDepTypeAnnotation.class)).append("\t");
        buf.append("_").append("\t");
        String misc = this.get(CoreAnnotations.CoNLLUMisc.class);
        if(misc==null) misc= "_";
		buf.append(misc);
        break;}
    case CoNLLcoref:{
        ...
        buf.append(this.get(CoreAnnotations.CoNLLDepTypeAnnotation.class)).append("\t");
        buf.append("_").append("\t");
        buf.append(this.get(CoreAnnotations.CoNLLUMisc.class)).append("\t");
        buf.append(this.get(CoreAnnotations.CoNLLCorefAnnotation.class));
        break;}
    case ALL:{
