...
//		getContentPane().add(new PipelineViewer());
	...
	protected void save(String file, Map<String, List<Pair<String, Map<String, List<SemanticGraph>>>>> allCorpusProcessed) {
		try {
			...
			for (String corpus : allCorpusProcessed.keySet()) {
				...
				for (Pair<String, Map<String, List<SemanticGraph>>> sentInfo : allCorpusProcessed.get(corpus)) {
